...
to make-turtles
  ...
  create-turtles num-pavlov [set strategy "pavlov" set color magenta ]
end
...
to update-history
  ...
  if strategy = "pavlov" [ pavlov-history-update ]
end
...
to do-scoring
  ...
  set pavlov-score  (calc-score "pavlov" num-pavlov)
end
...
"pavlov" 1.0 0 -5825686 true "" "if num-pavlov-games > 0 [ plot pavlov-score / (num-pavlov-games) ]"
